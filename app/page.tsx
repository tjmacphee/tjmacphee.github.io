...
export default function Home() {
  ...
  const handleSetActive = (link) => {
    ...
    if (section) {
      // if about section, scroll to top
      if (section.id === 'about') {
  ...
  useEffect(() => {
    ...
    // Set the initial active link based on the current scroll position
    ...
    handleInitialScroll(); // Call once on mount
  ...
  return (
    <main className="min-h-screen bg-background-color py-8 flex justify-center">
      ...
      <div className="max-w-7xl w-full flex px-4 lg:px-12">
        ...
        {/* Left Column: Name, Title, Navigation (Hidden on Mobile) */}
        <aside className="hidden lg:flex flex-col w-2/5 items-start p-8">
          {/* Name and Title */}
          <div className="mb-12">
            ...
            <div className="flex justify-center space-x-6 mt-6">
              <div className="flex items-center space-x-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-600 hover:transition text-2xl"
                  aria-label="GitHub"
                >
                  <FaGithub />
                </a>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <section id="projects" className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                  <div className="p-4">
                    <h3 className="text-gray-600 text-xl font-semibold mb-2">Ultrasonic ASM Sensor</h3>
                    <p className="text-gray-600 mb-4">
